...
public class RxDataTool {
    ...
    public static List<String> strToList(String string) {
        ...
        if (isEmpty(string)) return stringList;
        if (string.contains(",")) {
    ...
    /**
     * 把带有regex的string字符转换为string集合
     *
     * @param string 字符串
     * @return String 集合
     */
    public static List<String> strToList(String string, String regex) {
        List<String> stringList = new ArrayList<>();
        if (isEmpty(string)) return stringList;
     ...
     * @return String[] 数组
     */
    public static String[] strToStrSz(String string) {
        return string.split(",");
    }
