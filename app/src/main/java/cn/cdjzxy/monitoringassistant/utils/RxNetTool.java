...
public class RxNetTool {
    ...
    private static final String TAG = "RxNetTool";
    /**
     * no network
     */
        ...
        if (ni != null && ni.isConnectedOrConnecting()) {
            ...
            switch (ni.getType()) {//获取当前网络的状态
                case ConnectivityManager.TYPE_WIFI:// wifi的情况下
                    ...
                    Log.i(TAG, "getNetWorkType:切换到wifi环境下 ");
                ...
                case ConnectivityManager.TYPE_MOBILE:
                    ...
                    switch (ni.getSubtype()) {
                        ...
                        case TelephonyManager.NETWORK_TYPE_IDEN:
                            netType = NETWORK_2G;
                            Log.i(TAG, "getNetWorkType:切换到2G环境下 ");
                            break;
                        ...
                        case NETWORK_TYPE_TD_SCDMA:
                            netType = NETWORK_3G;
                            Log.i(TAG, "getNetWorkType:切换到3G环境下 ");
                            break;
                        case TelephonyManager.NETWORK_TYPE_LTE:

                        case NETWORK_TYPE_IWLAN:
                            netType = NETWORK_4G;
                            Log.i(TAG, "getNetWorkType:切换到4G环境下 ");
                            break;
                        default:
            ...
            netType = NETWORK_NO;
            Log.i(TAG, "getNetWorkType:当前无网络连接 ");
        }
        return netType;
    }
