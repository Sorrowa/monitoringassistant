...
/** 
 * DAO for table "SAMPLING_DETAIL".
*/
public class SamplingDetailDao extends AbstractDao<SamplingDetail, String> {

    public static final String TABLENAME = "SAMPLING_DETAIL";

    /**
     * Properties of entity SamplingDetail.<br/>
    ...
    public SamplingDetailDao(DaoConfig config) {
        super(config);
    }
    
    public SamplingDetailDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"SAMPLING_DETAIL\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"SAMPLING_DETAIL\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, SamplingDetail entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, SamplingDetail entity) {
        stmt.clearBindings();
    ...
    @Override
    public SamplingDetail readEntity(Cursor cursor, int offset) {
        SamplingDetail entity = new SamplingDetail( //
    ...
    @Override
    public void readEntity(Cursor cursor, SamplingDetail entity, int offset) {
    ...
    @Override
    protected final String updateKeyAfterInsert(SamplingDetail entity, long rowId) {
        return entity.getId();
    }
    
    @Override
    public String getKey(SamplingDetail entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(SamplingDetail entity) {
