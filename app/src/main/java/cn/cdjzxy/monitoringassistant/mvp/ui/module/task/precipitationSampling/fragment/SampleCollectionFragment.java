package cn.cdjzxy.monitoringassistant.mvp.ui.module.task.precipitationSampling.fragment;
...
public class SampleCollectionFragment extends BaseFragment {
    ...
    private PrecipitationSamplingCollectAdapter mPrecipitationSamplingCollectAdapter;
    ...
    public View initView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_precipitation_sampling_collect, null);
    }
    ...
    private void initRecyclerViewData() {
        ...
        mPrecipitationSamplingCollectAdapter = new PrecipitationSamplingCollectAdapter(mTabs);
        mPrecipitationSamplingCollectAdapter.setOnItemClickListener(new DefaultAdapter.OnRecyclerViewItemClickListener() {
            @Override
            public void onItemClick(View view, int viewType, Object data, int position) {

            }
        });
        recyclerview.setAdapter(mPrecipitationSamplingCollectAdapter);
    }
}
