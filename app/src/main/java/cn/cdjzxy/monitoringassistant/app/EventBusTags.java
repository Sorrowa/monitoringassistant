...
public interface EventBusTags {
    ...
    String TAG_NOISE_FRAGMENT_TYPE_SOURCE_EDIT = "TAG_NOISE_FRAGMENT_TYPE_SOURCE_EDIT";//噪声——噪声源
    String TAG_NOISE_FRAGMENT_TYPE_POINT_EDIT = "TAG_NOISE_FRAGMENT_TYPE_POINT_EDIT";//噪声——点位
    String TAG_NOISE_FRAGMENT_TYPE_MONITOR_EDIT = "TAG_NOISE_FRAGMENT_TYPE_MONITOR_EDIT";//噪声——检测值
}
