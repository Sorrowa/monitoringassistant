package cn.cdjzxy.monitoringassistant.trajectory.receiver;
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (Intent.ACTION_SCREEN_OFF.equals(action)) {
            ...
            System.out.println(String.format("GPS status, statusCode:%d, statusMessage:%s", statusCode,
                    statusMessage));
            Log.i(TAG, "onReceive: " + String.format("GPS status, statusCode:%d, statusMessage:%s", statusCode,
                    statusMessage));
            Log.e(TAG, "onReceive: " + String.format("GPS status, statusCode:%d, statusMessage:%s", statusCode,
                    statusMessage));
