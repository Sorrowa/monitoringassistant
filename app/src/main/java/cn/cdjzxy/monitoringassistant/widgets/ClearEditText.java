...
public class ClearEditText extends android.support.v7.widget.AppCompatEditText implements View.OnFocusChangeListener, TextWatcher {
    ...
    private void init() {
        ...
        if (mClearDrawable == null) {
            mClearDrawable = ContextCompat.getDrawable(context, R.drawable.delete_selector);
        }
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        if (mClearDrawable != null && event.getAction() == MotionEvent.ACTION_UP) {
            ...
            //判断触摸点是否在水平范围内
            boolean isInnerWidth = (x > (getWidth() - getTotalPaddingRight()) - 20) &&
    ...
    //    @Override
    //    protected void onDraw(Canvas canvas) {//得到Drawable集合  分别对应 左上右下
