package com.wonders.health.lib.base.widget.state.manager;
...
import com.wonders.health.lib.base.widget.state.loader.StateLoader;
import com.wonders.health.lib.base.widget.state.loader.StateRepository;
import com.wonders.health.lib.base.widget.state.state.BaseState;
import com.wonders.health.lib.base.widget.state.state.CoreState;
import com.wonders.health.lib.base.widget.state.state.IState;
...
public class StateManager implements StateViewManager, StateLoader, StateChanger {
    ...
    public View setContentView(int layoutId) {
        ...
        if (overallView == null) {
            ...
            overallView.setLayoutParams(new FrameLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT));
        }
