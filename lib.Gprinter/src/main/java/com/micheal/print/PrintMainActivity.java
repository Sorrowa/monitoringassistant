...
//    private static final String                   DEBUG_TAG                 = "PrintMainActivity";
...
//    private String projectName, transCode, sampleAddr, monIthems, time, name;
...
//                        }
//                    } else {
//                        Toast.makeText(PrintMainActivity.this, "query printer status error", Toast.LENGTH_SHORT).show();
//                    }
...
//        sampleAddr = getIntent().getStringExtra("sampleAddr");
//        monIthems = getIntent().getStringExtra("monIthems");
//        time = getIntent().getStringExtra("time");
//        name = getIntent().getStringExtra("name");
//
//        String labelStr = getIntent().getStringExtra(LABEL_STR);
//
//        if (!TextUtils.isEmpty(labelStr)) {
//            labelList = gson.fromJson(labelStr, new TypeToken<ArrayList<Label>>() {
//            }.getType());
//        }
...
//        int x = 20, h = 0;
//        // 绘制简体中文
//        tsc.addText(15, 30, LabelCommand.FONTTYPE.SIMPLIFIED_CHINESE, ROTATION.ROTATION_0,
//                FONTMUL.MUL_1, LabelCommand.FONTMUL.MUL_1,
//                label.getProjectName() + "\n");
//        tsc.addText(15, 90 - x, LabelCommand.FONTTYPE.SIMPLIFIED_CHINESE, ROTATION.ROTATION_0,
//                FONTMUL.MUL_1, LabelCommand.FONTMUL.MUL_1,
//                "样品编号: " + label.getSampleCode() + "\n");
//        tsc.addText(15, 130 - x, FONTTYPE.SIMPLIFIED_CHINESE, ROTATION.ROTATION_0,
//                FONTMUL.MUL_1, FONTMUL.MUL_1,
//                "采样地点: " + label.getSampleAddress() + "\n");
//
//        tsc.addText(15, 170 - x, FONTTYPE.SIMPLIFIED_CHINESE, ROTATION.ROTATION_0,
//                FONTMUL.MUL_1, FONTMUL.MUL_1,
//                "采样人员: " + label.getSampler() + "\n");
//
//        tsc.addText(15, 210 - x, FONTTYPE.SIMPLIFIED_CHINESE, ROTATION.ROTATION_0,
//                FONTMUL.MUL_1, FONTMUL.MUL_1,
//                "采样日期: " + label.getSampleDate() + "\n");
//        if (label.getMonItemNames().length() <= 20) {
//            h = 0;
//            tsc.addText(15, 250 - x, FONTTYPE.SIMPLIFIED_CHINESE, ROTATION.ROTATION_0,
//                    FONTMUL.MUL_1, FONTMUL.MUL_1,
//                    "监测项目: " + label.getMonItemNames() + "\n");
//        } else if (label.getMonItemNames().length() > 20 && label.getMonItemNames().length() < 50) {
//            h = 40;
//            tsc.addText(15, 250 - x, FONTTYPE.SIMPLIFIED_CHINESE, ROTATION.ROTATION_0,
//                    FONTMUL.MUL_1, FONTMUL.MUL_1,
//                    "监测项目: " + label.getMonItemNames().substring(0, 19) + "\n");
//
//            tsc.addText(15, 290 - x, FONTTYPE.SIMPLIFIED_CHINESE, ROTATION.ROTATION_0,
//                    FONTMUL.MUL_1, FONTMUL.MUL_1, label.getMonItemNames().substring(19, label.getMonItemNames().length() - 1) + "\n");
//
//        } else if (label.getMonItemNames().length() > 50) {
//            h = 40;
//            tsc.addText(15, 250 - x, FONTTYPE.SIMPLIFIED_CHINESE, ROTATION.ROTATION_0,
//                    FONTMUL.MUL_1, FONTMUL.MUL_1,
//                    "监测项目: " + label.getMonItemNames().substring(0, 19) + "\n");
//
//            tsc.addText(15, 290 - x, FONTTYPE.SIMPLIFIED_CHINESE, ROTATION.ROTATION_0,
//                    FONTMUL.MUL_1, FONTMUL.MUL_1, label.getMonItemNames().substring(19, 49) + "...\n");
//
//        }
//        tsc.addText(15, 290 - x + h, FONTTYPE.SIMPLIFIED_CHINESE, ROTATION.ROTATION_0,
//                FONTMUL.MUL_1, FONTMUL.MUL_1,
//                "样品分析: 口样品交接  口分析中  口分析完毕");
//
//
//        tsc.addQRCode(410, 30, EEC.LEVEL_L, 5, ROTATION.ROTATION_0, label.getSampleCode() == null ? " www.smarnet.cc" : label.getSampleCode());
